  ...
  return (
    <div className="container" style={{ padding: "58px 0 96px" }}>
      ...
      <div style={{ width: "min(100%, 680px)", marginTop: 36 }}>
        ...
        <p className="muted" style={{ margin: "16px 0 30px", lineHeight: 1.65 }}>Give this comparison a clear name so you can find it again. Next, you will upload quotations from your vendors.</p>
        <form action={createComparison} className="card" style={{ padding: "clamp(22px, 5vw, 34px)", display: "grid", gap: 22 }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, flexWrap: "wrap" }}>
            ...
            <button className="button" type="submit">Continue to Upload</button>
          </div>
        </form>
      </div>
    </div>
